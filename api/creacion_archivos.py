...
class CrearCertificacionSaldosAcreedores(ConsultaBD):
    ...
    def crear_certificacion(self):
        ...
        Público Autorizado de BANESCO (PANAMÁ), S.A, con registro único de contribuyente número 36633-66-264068 D.V. 11, 
        certifico y hago constar que los libros de contabilidad de BANESCO (PANAMA), S.A., arrojan al {self.resultado_consulta[0][0]},
        a favor de dicho Banco por un total de {self.resultado_consulta[0][1]}, los siguientes saldos acreedores contra 
        {self.resultado_consulta[0][2]+' '+self.resultado_consulta[0][3]}, con identificación/Ruc número {self.resultado_consulta[0][4]},
        correspondiente a las siguientes obligaciones: 
        """
        ...
        num_pres_producto.add_run(self.resultado_consulta[0][5]+' No. '+self.resultado_consulta[0][6])
        ...
        celda_derecha.add_paragraph(self.resultado_consulta[0][7])
        ...
        celda_derecha = tabla.cell(6,1)
        celda_derecha.add_paragraph(self.resultado_consulta[0][12])
